...
IDEV.Keys = {
    ...
    ControlKey = 'u', -- Key to use the keys on vehicle, NOTE: if you change this (only if you're already joined your server with the script started), you need to clear your fivem cache (client cache) since controls are cached into FiveM
